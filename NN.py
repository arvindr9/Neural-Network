...
for vecs in word_vec_nn:
	for i in range(0,2790):
		if vecs[i]==0:
			zeroes.append(i)
for i in range(0,2790):
	if zeroes.count(i)==10000:
		delete.append(i)

print delete"""

nonzeroes = set(range(0,2790))-set(iezeroes)

nonzeroes = list(nonzeroes)
